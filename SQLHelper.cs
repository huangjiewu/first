...
namespace WindowsFormsApplication1
{
    class SQLHelper
    {
        ...
        {
            string str = "HoUfn89oPrwoI8wdF1zZUDFcWRqHEDqBX/bzphbWVHKgrpQN+D6bxxaRhs0deBr4RTFxz41+rC1g7iROxJqLZERmWzfaNlh/bv6IdVPWSaiMop+vCS4v1SG1P+ekQMx1lcM1j1Tl6rHFNFo96qqcrm9T0B48x3Va06pM24fDtjBEkjBaCj+O7BgqyaseYbf4";
            //string str = "H4+loC28XCUnVInp85BZLf2fkipknJLj+KASm3CiNG/5d2t5cgnFH/M40KIpCZ/kISpZ25LwCKoKwubJwTkAUMCOV/r7j/LxSpd+6HPihYsfkNgsF9FGeku7gemsiMLjqqy3+HYR2TUDw0QdQC6vD19egbnWjQaZxcL/fzDGjlC6so36iqzGc1DNAMNY9sUX";
            String conn = Cryptography.RijndaelDecrypt(str);
            return conn;
        }
        #endregion
        #region 执行sql字符串 
        ...
        /// <param name="Sqlstr">SQL语句</param> 
        /// <returns></returns> 
        public static DataTable ExecuteDt(String Sqlstr, SqlParameter[] prams)
        {
